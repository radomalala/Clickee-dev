                                    ...
                                    <div class="col-md-12">
                                        <div class="box-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    {!! Form::select('type', [''=>'Select Input Type','1' => 'COUP DE COEUR', '2' => 'MEILLEURES VENTES','3' => 'MIEUX NOTÉS'],(isset($attribute)) ? $attribute->type : null,['class'=>'form-control required','id'=>'input_type']) !!}
                                                </div>
                                            </div>
