    ...
    <div class="product-area">
            ...
            <div class="container">
                            ...
                            <div class="row">
                                <div class="col-lg-12 pb-10 pt-0 p-lr-0 vcenter mt-0 mb-10 mr-l-20">
                                    @foreach($attribute_value as $attribute)
                                        <div class="color-box">
                                            <label class="color-label">{!! $attribute['name'] !!} : </label>
                                        </div>
                                        <div class="color-box">
                ...
                <div class="tabs-details">
                    <input type="button" name="btn_details" id="btn_details" value="{!! trans('product.more_details') !!}">
                </div>

                <!-- service-area-2-start -->
                <div class="sevice-area-bg">
                    <div class="container">
