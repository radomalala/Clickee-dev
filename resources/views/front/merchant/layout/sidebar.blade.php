<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            @if(check_merchant_access(['dashboard']))
            ...
            @endif
            @if(check_merchant_access(['category','brand.index','attribute','attribute_set','special-product.index','epartner.index', 'product']))
            ...
            @if(check_merchant_access(['page.index','email-template.index','coupon','banner.index']))
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ set_active(['admin/banner','admin/banner/*']) }}">
                        <a href="{!! URL::to('/admin/banner') !!}"><i class="fa fa-circle-o"></i> Gestion des bannières</a>
                    </li>
                    @endif
                    @if(check_merchant_access('special-product.index'))
            ...
            <!-- @if(check_merchant_access(['blog.index','blog-category.index']))
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        @if(check_merchant_access('blog-category.index'))
                        ...
                        @endif
                        @if(check_merchant_access('blog.index'))
            ...
            @if(check_merchant_access(['product-rating.index','price_adjustment','affiliate.index']))
            <li class="treeview {{ set_active(['admin/claim/price-adjustment','admin/claim/price-adjustment/*','admin/affiliate','admin/affiliate/*','admin/product-rating','admin/product-rating/*',]) }}">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    @if(check_merchant_access('product-rating.index'))
                    ...
                    @endif
                    @if(check_merchant_access('price_adjustment'))
                    ...
                    @if(check_merchant_access('affiliate.index'))
            ...
            @if(check_merchant_access(['customer.index','store.index','administrator','role.index']))
            <li class="treeview {{ set_active(['admin/role','admin/role/*','admin/customer','admin/customer/*','admin/store','admin/store/*','admin/administrator','admin/administrator/*']) }}">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    @endif
                    @if(check_merchant_access('role.index'))
            ...
            @if(check_merchant_access(['orders','order-status.index']))
            <li class="treeview {{ set_active(['admin/order-status','admin/order-status/*','admin/sales/*']) }}">
                ...
                <ul class="treeview-menu">
                      <li class="treeview {{ set_active(['admin/sales/*']) }}">
                        ...
                        <ul class="treeview-menu">
                            @if(check_merchant_access('orders'))
                    ...
                    @if(check_merchant_access('order-status.index'))
       ...
       <!--  @if(check_merchant_access(['product_billed','orders']))
            <li class="treeview {{ set_active(['admin/statistics/sales','admin/statistics/sales/*','admin/finance','admin/finance/*']) }}">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    @endif -->
                    <!-- @if(check_merchant_access('product_billed'))
                    ...
                    @endif
                    @if(check_merchant_access('company_account'))
            ...
            @if(check_merchant_access(['epartner.index','epartner.index','email-template.index','update_setting', 'setting_update']))
